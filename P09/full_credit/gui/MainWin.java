 package gui;
//help from the suggested solution of sprint 3
...
public class MainWin extends JFrame {
    ...
    public MainWin(String title) {
       ...
       JButton bNew = new JButton(new ImageIcon("gui/resources/file_new.png"));
        ...
        bJava  = new JButton(new ImageIcon("gui/resources/new_java.png"));
         ...
         //help from suggested solution of sprint 3
    ...
    // from the lecture 14
        ...
        SpinnerModel range = new SpinnerNumberModel(0, 0, 100000, 0.01);
        prices = new JSpinner(range);
         JLabel cost = new JLabel("<HTML><br/>Cost</HTML>");
        SpinnerModel range = new SpinnerNumberModel(0, 0, 100000, 0.01);
        costs = new JSpinner(range);
        JLabel darkness = new JLabel("<HTML><br/>Darkness</HTML>");
        String[] darkness_text = {"Blond","Light","Medium","Dark","Extreme"};
        Darkness = new JComboBox<String>(darkness_text);
        JLabel shot = new JLabel("<HTML><br/>Addd a Shot</HTML>");
        String[] shot_text = {"None","Milk","Sugar","Creamer","Chocolate","Vanilla","Hazelnut","Peppermint"};
      shots = new JComboBox<String>(shot_text);
        Object[] objects = { // Array of widgets to display 
         ...
         this,
         names.getText() + " ("
             + Darkness.getSelectedItem() + " "
            + " price " + prices.getValue() + ")")
            + " cost "+costs.getValue()+")"
             +shots.getSelectedItem() +" ");   
   ...
   try{
       JLabel name = new JLabel("<HTML><br/>Name</HTML>");
        ...
        SpinnerModel range = new SpinnerNumberModel(0, 0, 100000, 0.01);
        costs = new JSpinner(range);
        JLabel frosting = new JLabel("<HTML><br/>Frosting</HTML>");
        String[] frosting_text = {"Unfrosted","Glazed","ChocolateVanilla","Strawberry","Creme","Cherry"};
        Frosting = new JComboBox<String>(frosting_text);
        JLabel filling = new JLabel("<HTML><br/>Filling</HTML>");
        String[] filling_text = {"Unfilled","Creme","Bavarian","Strawberry"};
      Filling = new JComboBox<String>(filling_text);
      JLabel sprinkles = new JLabel("<HTML><br/>Sprinkles</HTML>");
        String[] sprinkles_text = {"No Sprinkles","sprinkles"};
     Sprinkles = new JComboBox<String>(sprinkles_text);
        ...
        Object[] objects = { // Array of widgets to display 
         ...
         this,
         names.getText() + " ("
             + Frosting.getSelectedItem() + " "
            + " price " + prices.getValue() + ")")
            + " cost "+costs.getValue()+")"
            + Sprinkles.getSelectedItem()+ " "
            + Filling.getSelectedItem() +" "); 
}  catch (CancelDialogException e) { // ignore a Cancel
        } catch(Exception e) {
 ...
 protected void onCreateCustomerClick(){ //help from suggested solution of sprint 3
 try{
   JLabel name = new JLabel("<HTML><br/>Name</HTML>");
        names = new JTextField(20);
   JLabel phone = new JLabel("<HTML><br/>Phone</HTML>");
    ...
    private JButton bCustomer;                // Button to select 2 sticks
}
